...
class FragmentEdit : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        dataE = (requireActivity().findViewById<View>(R.id.editE) as EditText)
    ...
    override fun onDestroy() {
        ...
        parentFragmentManager.setFragmentResult("childFragmentData", bundleOf(Pair("text_field", data)))
